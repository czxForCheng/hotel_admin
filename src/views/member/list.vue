...
<!--                            更多操作-->
                          ...
                          <template #dropdown>
                            <div style="padding: 5px 20px;">
                              <el-dropdown-menu>
                                <div>
                                  <el-button type="primary" size="small" v-perms="['userManage:addAmount']" @click="handleOpenMoney(row.id, 1)">赠送彩金</el-button>
                                  <el-button type="primary" size="small"  v-perms="['userManage:sendDeposit']" @click="handleOpenMoney(row.id, 2)">赠送存款</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:beDummy']" @click="handleBeDummy(row)">设为{{row.isDummy?'真人':'假人'}}</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:billList']">
                                    <router-link
                                        :to="{
                                  ...
                                  <el-button type="primary" size="small" v-perms="['userManage:OSDT']" @click="handleOpenUsdt(row)">USDT信息</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:updatePwd']" @click="handleUpdatePwd(row)" v-show="userInfo.agentLevel !== 2">登录密码</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:updateTradingPwd']" @click="handleUpdateTradingPwd(row)" v-show="userInfo.agentLevel !== 2">交易密码</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:disableWithdrawal']" @click="handleDisableWithdrawal(row)">{{ row.isWithdrawal ? '允许提现' : '禁止提现' }}</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:frozenAmount']" @click="handleOpenMoney(row.id, 3)">冻结余额</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:teamList']">
                                    <router-link
                                        :to="{
                                  ...
                                  <el-button type="primary" size="small" v-perms="['userManage:disable']" @click="handleDisable(row)">{{ row.isDisable ? '启用' : '禁用' }}</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:edit']" @click="handleEdit(row)">编辑</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:del']" @click="handleDelete(row.id)">删除</el-button>
                                  <el-button type="primary" size="small" v-perms="['userManage:resetInput']" @click="handleOpenNum(row.id)">修改抢单数量</el-button>
